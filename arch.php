              ...
              <?php
                  ...
                  if(isset($_GET['page'])){
                    $page = $_GET['page'];
                        ...
                        $sql = mq("SELECT id, title, IFA_P, IFA_A, IFA_R, AFC_P, AFC_A, AFC_R, TR_No, TR_Date, Dwg_R, Subcon, Re_Date, Remark FROM arch ORDER BY time");
                        ...
                        $sql2 = mq("SELECT id, title, IFA_P, IFA_A, IFA_R, AFC_P, AFC_A, AFC_R, TR_No, TR_Date, Dwg_R, Subcon, Re_Date, Remark FROM arch ORDER BY time LIMIT $start_num, $list");  
...
//                          }
  ...
  <div id="search_box">
    <form action="/page/board/search_result_arch.php" method="get">
      <select name="catgo">
