    ...
    <?php
     ...
     <table class="list-table">
            <thead>
              ...
              <?php
                        $sql2 = mq("SELECT id, title, IFA_P, IFA_A, IFA_R, AFC_P, AFC_A, AFC_R, TR_No, TR_Date, Dwg_R, Subcon, Re_Date, Remark FROM arch where $catagory like '%$search_con%' ORDER BY time");  
